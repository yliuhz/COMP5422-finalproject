...
% Generative Adaptive Facial Expression Editing with language understanding
% Context-Driven Adaptive Generative Editing of Facial Expressions
% Generative Adaptive Facial Expression Editing with Large Language Models
...
%    Maybe the abstract part is unnecessary.
% \end{abstract}
\input{0.proposal}
